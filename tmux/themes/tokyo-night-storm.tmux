...
set -g status-right '#[fg=#f7768e]#(cd "#{pane_current_path}" && git rev-parse --is-inside-work-tree >/dev/null 2>&1 && echo " $(git rev-parse --abbrev-ref HEAD)") #[fg=#bb9af7,bg=default,nobold]#[fg=#24283B,bg=#bb9af7,bold]  %d/%m #[fg=#24283B,bg=#2ac3de,bold]  %H:%M '
