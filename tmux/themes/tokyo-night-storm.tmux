...
set -g window-status-current-format '#[bg=default,fg=#bb9af7,nobold]#[fg=#24283B,bg=#bb9af7,bold] #W#[fg=#bb9af7,bg=default,nobold] '
...
set -g status-left '#[fg=#24283B,bg=#2ac3de,bold] 󰈸 #S #[fg=#2ac3de,bg=default,nobold] '

# === Right Status ===
set -g status-right-length 150
set -g status-right '#[fg=#f7768e]#(cd "#{pane_current_path}" && git rev-parse --is-inside-work-tree >/dev/null 2>&1 && echo " $(git rev-parse --abbrev-ref HEAD)") #[fg=#bb9af7,bg=default,nobold]#[fg=#24283B,bg=#bb9af7,bold]  %d/%m #[fg=#24283B,bg=#2ac3de,bold]  %H:%M #[fg=#2ac3de,bg=default,nobold]'
