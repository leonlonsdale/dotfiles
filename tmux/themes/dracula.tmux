...
set -g window-status-current-format '#[bg=default,fg=#F1FA8C,nobold]#[fg=#24283B,bg=#F1FA8C,bold] #W#[fg=#F1FA8C,bg=default,nobold] '
...
set -g status-left '#[fg=#24283B,bg=#BC93F9,bold] 󰈸 #S #[fg=#BC93F9,bg=default,nobold] '

# === Right Status ===
set -g status-right-length 150
set -g status-right '#[fg=#f7768e]#(cd "#{pane_current_path}" && git rev-parse --is-inside-work-tree >/dev/null 2>&1 && echo " $(git rev-parse --abbrev-ref HEAD)") #[fg=#8BE9FD,bg=default,nobold]#[fg=#24283B,bg=#8BE9FD,bold] %d/%m #[fg=#24283B,bg=#BC93F9,bold]  %H:%M #[fg=#BC93F9,bg=default,nobold] '
